						...
						<div class="white-box">
							<form action="user-update" method="post"
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input value="<%=request.getAttribute("fullname") %>" disabled="disabled" name="fullname" type="text" placeholder="Johnathan Doe"
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input value="<%=request.getAttribute("email") %>" disabled="disabled" type="email" placeholder="johnathan@admin.com"
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input disabled="disabled" value="1234" name="password" type="password" placeholder="password"
											class="form-control form-control-line">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-12">
										<input value="123 456 7890" disabled="disabled" name="phone" type="text" placeholder="123 456 7890"
											class="form-control form-control-line">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-12">
										<select name="role" class="form-control form-control-line">
											<option value="" selected hidden ><%=request.getAttribute("role") %></option>
