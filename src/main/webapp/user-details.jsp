							...
							<div class="user-bg">
								...
								<div class="overlay-box">
									<div class="user-content">
										...
										<h4 class="text-white"><%=request.getAttribute("fullname")%></h4>
										<h5 class="text-white"><%=request.getAttribute("email")%></h5>
									</div>
								</div>
							</div>
						...
						<div class="white-box">
							...
							<div class="message-center">
								<c:forEach var="item" items="${listTask}">
									<c:if test="${item.status == 'Chưa thực hiện'}">
										<a href="#">
											<div class="mail-contnet">
												<h5>${item.name}</h5>
												<span class="mail-desc"></span> <span
													class="time">Bắt đầu: ${item.start_date}</span> <span
													class="time">Kết thúc: ${item.end_date}</span>
											</div>
										</a>
									</c:if>
								</c:forEach>
